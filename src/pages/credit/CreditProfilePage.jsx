...
const CreditProfilePage = () => {
    ...
    const handleAction = (newStatus, notes = '') => {
                                ...
                                {[
                                    ...
                                    <div key={i} className="p-6 bg-slate-950 border border-slate-800 rounded-3xl group hover:border-blue-500/50 transition-all">
                                        ...
                                        <div className="flex gap-2 mt-6">
                                            <button className="flex-1 py-2 rounded-xl bg-slate-900 border border-slate-800 text-[10px] font-bold text-slate-400 hover:text-white transition-all">View</button>
                                            <button className="flex-1 py-2 rounded-xl bg-blue-600/10 text-blue-400 text-[10px] font-bold hover:bg-blue-600 hover:text-white transition-all">Download</button>
                                        </div>
                                    </div>
                                ))}
                             </div>
            ...
            <Modal
                ...
                footer={(
                    <div className="flex gap-4">
                        ...
                        <button 
                            onClick={() => handleAction(STATUSES.APPROVED, `Approved: R ${approveData.amount} for ${approveData.term} mo @ ${approveData.interest}%`)}
                ...
                footer={(
                    <div className="flex gap-4">
                        ...
                        <button 
                            ...
                            onClick={() => handleAction(STATUSES.DECLINED, rejectReason)}
            ...
            <Modal
                ...
                footer={(
                    <div className="flex gap-4">
                        ...
                        <button 
                            disabled={!holdReason}
                            onClick={() => handleAction(STATUSES.ON_HOLD, holdReason)}
            ...
            <Modal
                ...
                footer={(
                    <div className="flex gap-4">
                        ...
                        <button 
                            disabled={!requestMsg}
                            onClick={() => handleAction(STATUSES.NEED_MORE_INFO, requestMsg)}
