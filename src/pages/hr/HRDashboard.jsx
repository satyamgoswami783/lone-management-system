      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass rounded-[32px] overflow-hidden border border-slate-800/50">
            <div className="p-6 border-b border-slate-800/50 flex items-center justify-between bg-slate-900/20">
                <h2 className="text-xl font-display font-bold">Priority Queue</h2>
            ...
            <div className="divide-y divide-slate-800/50">
                {recentVerifications.length > 0 ? (
                    ...
                    <div className="p-12 text-center text-slate-500 italic">No applications found.</div>
                )}
            </div>
          </div>
          ...
          <div className="space-y-6">
              <div className="glass p-8 rounded-[40px] border-slate-800/50 bg-gradient-to-br from-blue-600/10 to-transparent space-y-6">
              ...
              <div className="glass p-8 rounded-[40px] border-slate-800/50 bg-slate-900/40 space-y-4">
...
const ShortcutCard = ({ title, description, icon: Icon, onClick }) => (
    <button 
        onClick={onClick}
        className="p-6 glass rounded-3xl border-slate-800/50 hover:border-blue-500/30 transition-all group lg:text-left"
    >
        <div className="w-10 h-10 rounded-2xl bg-slate-900 flex items-center justify-center text-slate-400 group-hover:text-blue-400 transition-all mb-4">
